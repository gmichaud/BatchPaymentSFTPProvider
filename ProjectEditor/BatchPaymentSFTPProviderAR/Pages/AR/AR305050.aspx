...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" Caption="Batch Summary" DataMember="Document" DefaultControlID="edBatchNbr" FilesIndicator="True" NoteIndicator="True" LinkIndicator="True"
		...
		<Template>
            ...
            <px:PXSelector ID="edProcessingCenterID" runat="server" DataField="ProcessingCenterID"></px:PXSelector>
		    <px:PXDateTimeEdit ID="edFileTransferTime" runat="server" DataField="FileTransferTime"></px:PXDateTimeEdit>
		</Template>
	</px:PXFormView>
</asp:Content>
